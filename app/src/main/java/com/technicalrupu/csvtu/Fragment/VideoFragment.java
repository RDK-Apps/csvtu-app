...
public class VideoFragment extends Fragment {
    ...
    public VideoFragment(String sid, String sName) {
        this.Sid=sid;
        this.Sname=sName;
    }
    @Override
    ...
    public void getVideos(String sid, String sName)
    {
        ...
        call.enqueue(new Callback<Notes>() {
            ...
            public void onResponse(Call<Notes> call, Response<Notes> response) {
                if(response.body().getStatus().equals("100")) {
                    ...
                    Toast.makeText(getContext(),"Videos Not Found...",Toast.LENGTH_SHORT).show();
                    getActivity().finish();
